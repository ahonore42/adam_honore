  ...
  return (
    <div className={classes.root}>
      <AppBar position="static">
        <Toolbar style={{backgroundColor: 'black', height: '10vh', color: 'rgba(255, 224, 250, 1)'}}>
          <h1 className="footTitle" edge="start">
            Adam Honoré
          </h1>
